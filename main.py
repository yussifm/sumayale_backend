...
# Load model and processor from Hugging Face at startup
logger.info("Loading Akan-finetuned Whisper model and processor...")
try:
    model_id = "dennis-9/whisper-akan-finetuned"
...
async def transcribe_audio(file: UploadFile = File(...)):
    """
    Transcribe an uploaded audio file using the Akan-finetuned Whisper model.
...
async def health_check():
    ...
    return {"status": "healthy", "model": "dennis-9/whisper-akan-finetuned"}
